...
- **Bridge plugin**: the Lua plugin running inside FH (entry: `bridge/Claude MCP Bridge.fh_lua`
...
The Bridge plugin's own FH-dialog `@Title` is "Claude MCP Bridge" — a fourth, narrower
